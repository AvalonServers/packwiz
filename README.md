...
## Installation
Prebuilt binaries are available from [GitHub Actions](https://github.com/AvalonServers/packwiz/actions) - the UI is a bit terrible, but essentially select the top build, then download the artifact ZIP for your system at the bottom of the page.  
...
2. Run `go install github.com/AvalonServers/packwiz@latest`. Be patient, it has to download and compile dependencies as well!
